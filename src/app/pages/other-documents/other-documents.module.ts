...
import { SearchDebitNoteComponent } from './debit-note/search-debit-note/search-debit-note.component';
import { DebitNoteSummaryComponent } from './debit-note/debit-note-summary/debit-note-summary.component';
...
import { CustomerInfoDebitNoteComponent } from './debit-note/customer-info-debit-note/customer-info-debit-note.component';
import { DebitNoteDetailComponent } from './debit-note/debit-note-detail/debit-note-detail.component';
import { ProductItemsDebitNoteComponent } from './debit-note/product-items-debit-note/product-items-debit-note.component';
import { AddNewProductDebitNoteComponent } from './debit-note/add-new-product-debit-note/add-new-product-debit-note.component';
import { AddNewPackageDebitNoteComponent } from './debit-note/add-new-package-debit-note/add-new-package-debit-note.component';
