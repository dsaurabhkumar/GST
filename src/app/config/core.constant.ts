export const CoreConstant =  {
    ...
    countries: ["Afghanistan",
     ...
     measurementUnits: [
        "Select Unit", "Bag", "Bags", "Bails", "Bottles", "Bou", "Boxes", "Buckles", "Bulk", "Bunches", "Bundles", "Cans",
        "Cartons", "Cases", "Centimeter", "Chest", "Coils", "Collies", "Crates", "Cubic Centimeter", "Cubic Inches","Cubic Meter", "Cubic Meters", "Cylinder", "Days", "Decameter Square", "Dozen", "Drums", "Feet", "Flasks",		"Grams", "Great Gross", "Greate Britain Ton", "Gross", "Gross Yards", "Habbuck", "Hanks", "Hours", "Inches",
        "Inch Dia", "Inch Meter", "Job", "Jotta", "Kilograms", "Kiloliter", "Kilometers", "Liters", "Lines", "Logs",
        "Lots", "Meter", "Metric Ton", "Milli Grams", "Milli Litre", "Milli Meter", "Numbers", "Odds", "Others",
        "Package", "Packet", "Peck - Dry Measure", "Packs", "Pails", "Pairs", "Pallets", "Pieces", "Pounds", "Quintal",
        "Reels", "RIM", "Rolls", "Sets", "Sheets", "Slabs", "Sqaure Centimeters", "Sqaure Feet", "Square Inches",
        "Square Meter", "Square Yards", "Steel Blocks", "Strings", "Tables", "Tablets", "Ten Gross", "Thousands", "Tins",
        "Tola", "Trunk", "Tubes", "US Gallons", "Units", "Vials", "Wooden Cases", "Yards"
     ],
